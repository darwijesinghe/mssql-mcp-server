...
[![GitHub downloads](https://img.shields.io/github/downloads/darwijesinghe/mssql-mcp-server/total.svg)](https://github.com/darwijesinghe/mssql-mcp-server/releases)
...
1. Open **[Releases](https://github.com/darwijesinghe/mssql-mcp-server/releases)** and download the archive for your OS from the latest `v*` tag (see [RELEASE_NOTES.md](RELEASE_NOTES.md)):
